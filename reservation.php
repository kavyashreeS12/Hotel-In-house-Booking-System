...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <form role="form" id="booking" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-secondary pull-right" href="index.php?room_mang">Refresh</a>
                            </div>
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-secondary pull-right" style="border-radius:0%" href="index.php?reservation">Refresh</a>
                            </div>
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    <label>Room Type</label>
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">Developed By Kavyashree S</p>
        </div>
    </div>
</div>    <!--/.main-->
